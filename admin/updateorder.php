...
if (strlen($_SESSION['alogin']) == 0) {
  ...
  if (isset($_POST['submit2'])) {
    ...
    $sql = mysqli_query($con, "update orders set orderStatus='$status' where trackorder='$oid'");
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <option value="">Select Status</option>
                 <option value="in Process">In Process</option>
                  ...
                  <select name="status" id="statusSelect" class="fontkink" required="required">
                    <option value="">Select Status</option>
                    <option value="in process">In Process</option>
                    <option value="Delivered">Delivered</option>
                  </select>

                  <select name="paymentStatus" id="paymentStatus" class="fontkink" required="required">
                  ...
                  <script>
                    document.getElementById('statusSelect').addEventListener('change', function() {
                      ...
                      if (selectedStatus === 'in process') {
                        ...
                        paymentStatusSelect.value = ''; // Reset to default value
                      }
                    });
                  </script>
